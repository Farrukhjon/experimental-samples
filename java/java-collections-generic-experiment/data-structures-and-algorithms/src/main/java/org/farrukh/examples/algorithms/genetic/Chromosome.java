...
package org.farrukh.examples.algorithms.genetic;
...
public class Chromosome implements Comparable<Chromosome> {
	...
	/** The target gene, converted to an arrays for convenience. */
	private static final char[]	TARGET_GENE	= "Hello!, Farrukhjon".toCharArray();
	...
	/**
	 * Method to retrieve the fitness of this <code>Chromosome</code>. Note that
	 * a lower fitness indicates a better <code>Chromosome</code> for the
	 * solution.
	 * 
	 ...
	 * is defined as being the sum of the absolute value of the difference
	 ...
	 * mutation of this <code>Chromosome</code>. This method randomly selects
	 * one character in the <code>Chromosome</code>s gene, then replaces it with
	 * another random (but valid) character. Note that this method returns a new
	 ...
	 * another based on fitness. <code>Chromosome</code> ordering is based on
	 * the natural ordering of the fitnesses of the <code>Chromosome</code>s.
	 */
	@Override
