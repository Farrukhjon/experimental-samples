...
@ComponentScan({
    "org.farrukh.experiments.old.tech.dao",
    "org.farrukh.experiments.old.tech.service"
    })
public class SpringHibernateJavaConfig {
    ...
    private static final String ANNOT_MODEL_PATH = "org.farrukh.experiments.old.tech.model";
